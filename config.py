...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002360665787"))
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002335438886"))
...
try:
    ADMINS=[5082638362]
    for x in (os.environ.get("ADMINS", "7350721166 7749734225p").split()):
        ADMINS.append(int(x))
except ValueError:
